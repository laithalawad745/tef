...
CREATE TABLE "new_Member" (
    ...
    "tokenUsed" BOOLEAN NOT NULL DEFAULT true,
...
CREATE INDEX "Member_telegramId_idx" ON "Member"("telegramId");
CREATE INDEX "Member_channelId_idx" ON "Member"("channelId");
CREATE INDEX "Member_isActive_hasJoined_idx" ON "Member"("isActive", "hasJoined");
CREATE UNIQUE INDEX "Member_telegramId_channelId_key" ON "Member"("telegramId", "channelId");
